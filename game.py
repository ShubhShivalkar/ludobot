...
class Game:
    ...
    def __init__(self, ghost_players=[]):
        ...
        self.game_winners = []
        self.dice_value_count = np.zeros((4,6))
        self.ghost_players = ghost_players
        self.flag = True
    
    def getFlagOrigin(self):
        return self.flag
    ...
    def generate(self):
        ...
        while self.flag:
            ...
            if self.dice_value_count[self.current_player][dice - 1] == 5 :
                continue
            elif self.dice_value_count[0].sum() == 30:
                self.flag = False
                return 0
            self.dice_value_count[self.current_player][dice - 1] += 1
            print("dice used",self.dice_value_count)
            return dice
    ...
    def _dice_generator(self):
        ...
        self.current_dice = self.generate()
