...
DICE_MOVE_OUT_OF_HOME = [1,2,3,4,5,6]
NO_ENEMY = -1
...
class Player:
    ...
    def get_pieces_that_can_move(self, dice):
        ...
        for piece_i, piece_place in enumerate(self.pieces):
            ...
            elif BORD_TILES[piece_place] == TAILE_HOME and dice in DICE_MOVE_OUT_OF_HOME:
    ...
    def move_piece(self, piece, dice, enemys):
        ...
        # The Home areal
            ...
            if dice in DICE_MOVE_OUT_OF_HOME:
                self.pieces[piece] = START_INDEX + dice
        ...
        # The other stars
            ...
            next_star_staridx = present_star_staridx
